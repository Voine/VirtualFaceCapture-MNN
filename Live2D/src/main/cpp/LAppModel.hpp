...
#include "L2DMath/CubismTargetPointEx.hpp"
...
public:
     ...
     *
     */
    void Update(LAppModelParameters modelParameters);
...
private:
    ...
    */
    ...
    Csm::csmVector<Csm::csmInt32> _textureIds;
    Live2D::Cubism::Framework::CubismTargetPointEx* _targetPointManager; ///< 顔の座標処理クラス
