...
public:
    ...
    * Z軸の顔の向きの値を取得する。
    *
    * @return Z軸の顔の向きの値(-1.0 - 1.0)
    */
    csmFloat32  GetZ() const;
