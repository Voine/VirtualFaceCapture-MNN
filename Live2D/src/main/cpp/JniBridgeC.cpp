...
static jmethodID g_OnMotionPlayingMethodId;
static jmethodID g_OnMotionFinishedMethodId;
//加载表情回调
...
void JniBridgeC::OnLoadOneMotion(const char* motionGroup, signed int index, const char* motionName)
{
    JNIEnv *env = GetEnv();
...
extern "C"
{
    ...
    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectChangeToName(JNIEnv *env, jclass clazz,
                                                         jstring modelName) {
        auto modelNameStr = env->GetStringUTFChars(modelName, nullptr);
        LAppDelegate::GetInstance()->ModelChangeToName(modelNameStr);
        env->ReleaseStringUTFChars(modelName, modelNameStr);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectChangeTo(JNIEnv *env, jclass clazz,
                                                             jstring modelPath,
                                                             jstring modelJsonFileName) {
        auto modelPathStr = env->GetStringUTFChars(modelPath, nullptr);
        auto modelJsonFileNameStr = env->GetStringUTFChars(modelJsonFileName, nullptr);
        LAppDelegate::GetInstance()->ModelChangeTo(modelPathStr, modelJsonFileNameStr);
        env->ReleaseStringUTFChars(modelPath, modelPathStr);
        env->ReleaseStringUTFChars(modelJsonFileName, modelJsonFileNameStr);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeApplyMotion(JNIEnv *env, jclass clazz,
                                                                 jstring motionGroup, jint index) {
        auto motionGroupStr = env->GetStringUTFChars(motionGroup, nullptr);
        LAppDelegate::GetInstance()->ApplyMotion(motionGroupStr, index);
        env->ReleaseStringUTFChars(motionGroup, motionGroupStr);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeStopMotion(JNIEnv *env, jclass clazz) {
        LAppDelegate::GetInstance()->StopMotion();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeResetMotion(JNIEnv *env, jclass clazz) {
        LAppDelegate::GetInstance()->ResetMotion();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeApplyExpression(JNIEnv *env, jclass clazz, jstring expression_name){
    ...
    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeStopExpressions(JNIEnv *env, jclass clazz) {
        LAppDelegate::GetInstance()->StopExpression();
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectScale(JNIEnv *env, jclass clazz, jfloat scale) {
        LAppDelegate::GetInstance()->ModelResize(scale);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectTransformX(JNIEnv *env, jclass clazz, jfloat transform) {
        LAppDelegate::GetInstance()->ModelTranslateX(transform);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectTransformY(JNIEnv *env, jclass clazz, jfloat transform) {
        LAppDelegate::GetInstance()->ModelTranslateY(transform);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeModelEulerParameters(JNIEnv *env, jclass clazz,
                                                             jfloat pitch, jfloat yaw,
                                                             jfloat roll) {
        LAppDelegate::GetInstance()->ModelTranslateFace(yaw, pitch, roll);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeBreath(JNIEnv *env, jclass clazz, jboolean enabled) {
        LAppDelegate::GetInstance()->ModelBreath(enabled == JNI_TRUE);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeAutoBlinkEyes(JNIEnv *env, jclass clazz, jboolean enabled) {
        LAppDelegate::GetInstance()->ModelAutoBlinkEyes(enabled == JNI_TRUE);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectEyeLOpen(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelEyeLOpen(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectEyeROpen(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelEyeROpen(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectMouthForm(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelMouthForm(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectMouthOpenY(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelMouthOpenY(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectEyeBallX(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelEyeBallX(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectEyeBallY(JNIEnv *env, jclass clazz, jfloat value) {
        LAppDelegate::GetInstance()->ModelEyeBallY(value);
    }

    JNIEXPORT void JNICALL
    Java_com_live2d_demo_JniBridgeJava_nativeProjectManualEyeBall(JNIEnv *env, jclass clazz, jboolean enabled) {
        LAppDelegate::GetInstance()->ModelManualEyeBall(enabled == JNI_TRUE);
    }
}